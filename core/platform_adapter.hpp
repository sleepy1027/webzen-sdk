...
// (JNI_OnLoad on Android, an Objective-C++ global constructor on iOS, a
// global constructor on Windows) constructs the concrete adapters and keeps
// them alive for the process lifetime; the core only ever borrows them.
//
